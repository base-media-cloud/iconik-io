...
func (a *API) GetAsset(ctx context.Context, path, assetID string) (asset.DTO, error) {
...
func (a *API) PatchAsset(ctx context.Context, path, assetID string, payload []byte) (asset.DTO, error) {
	ctxTimeout, cancel := context.WithTimeout(ctx, a.cfg.OperationTimeout)
	defer cancel()
	zerolog.Ctx(ctxTimeout).Info().Msg("getting asset " + assetID + " from iconik")
